...
var _CarouselCaption = _interopRequireDefault(require("react-bootstrap/lib/CarouselCaption"));

var _CarouselItem = _interopRequireDefault(require("react-bootstrap/lib/CarouselItem"));

var _SafeAnchor = _interopRequireDefault(require("react-bootstrap/lib/SafeAnchor"));

var _ElementChildren = require("react-bootstrap/lib/utils/ElementChildren");

var _triggerBrowserReflow = _interopRequireDefault(require("react-bootstrap/lib/utils/triggerBrowserReflow"));

var _ThemeProvider = require("react-bootstrap/lib/ThemeProvider");
...
function (_React$Component) {
  ...
  Carousel.getDerivedStateFromProps = function getDerivedStateFromProps(nextProps, _ref) {
    ...
    if (nextProps.activeIndex !== previousActiveIndex) {
      ...
      if (previousActiveIndex >= lastPossibleIndex || previousActiveIndex <= nextIndex) {
        debugger
        direction = 'next';
      } else {
        direction = 'prev';
